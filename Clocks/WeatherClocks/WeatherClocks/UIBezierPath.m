...
{
    NSGraphicsContext *contextG = [NSGraphicsContext currentContext];
    CGContextRef context = (CGContextRef)contextG.graphicsPort;
...
- (void)addClip
{
    ...
    NSGraphicsContext *contextG = [NSGraphicsContext currentContext];
    CGContextRef currentContext = (CGContextRef)contextG.graphicsPort;
